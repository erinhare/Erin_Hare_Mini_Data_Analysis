This folder contains an **area_worst_range.csv** file which displays the range for the area_worst variable for both benign and malignant tumors which was from Task 4 in Milestone 1. 
